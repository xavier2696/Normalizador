...
//        }
        Set<Elemento> attrs = Elemento.crearElemento("C, T, H, R, S, G");
        Set<DependenciaFuncional> fds2 = DependenciaFuncional.crearDependencia("C-->T;H,R-->C;H,T-->R;C,S-->G;H,S-->R");
        Relation original = new Relation(attrs, fds2);
